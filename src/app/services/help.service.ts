  ...
  someName = (currentRoute: string) => {
    switch (currentRoute) {
      ...
      case 'elcs':
        ...
        break;
      case 'cs':
        this.addMessage('انتقاد و پیشنهاد', 'در صورتی­که کاربران نسبت به این وب سایت ، پیشنهاد یا انتقادی دارند یا درصورت مشاهده هرگونه خطا می ­توانند کارشناسان سازمان را از طریق این بخش باخبر سازند.', '', '', '');
        break;
      case 'registerNew':
