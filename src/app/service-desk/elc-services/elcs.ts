...
export const elcs: IElcServies[] = [
    ...
    { name: 'تغییر کاربری', id: 7, checked: false },
    ...
    { name: 'استعلام محضر', id: 26, checked: false },
    { name: 'قطع و وصل انشعاب', id: 27, checked: false },
    { name: 'جابجایی سیفون', id: 28, checked: false },
